          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '4px' }}>
              ...
              <div className="vault-analytics-3col-grid">
                ...
                <div style={{ background: cardBg, border: `1px solid ${borderColor}`, borderRadius: '16px', padding: '18px 20px', boxShadow: '0 4px 18px rgba(16,24,40,0.04)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', overflow: 'hidden', position: 'relative' }}>
                  <div>
                    <h4 style={{ margin: 0, fontSize: '15px', fontWeight: 700, color: textColor }}>Measurements Over Time</h4>
                    <span style={{ fontSize: '11px', color: secTextColor }}>Number of profiles created</span>
                  </div>

                  <div style={{ width: '100%', height: '200px', marginTop: '10px', paddingBottom: '5px' }}>
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={overTimeData} margin={{ top: 15, right: 15, left: -5, bottom: 25 }}>
                        <defs>
                        ...
                        <XAxis dataKey="date" stroke={mutedTextColor} fontSize={10} tickLine={false} height={30} dy={5} />
                        <YAxis stroke={mutedTextColor} fontSize={10} tickLine={false} width={32} />
                ...
                <div style={{ background: cardBg, border: `1px solid ${borderColor}`, borderRadius: '16px', padding: '18px 20px', boxShadow: '0 4px 18px rgba(16,24,40,0.04)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', overflow: 'hidden', position: 'relative' }}>
                  <div>
                    <h4 style={{ margin: 0, fontSize: '15px', fontWeight: 700, color: textColor }}>Accuracy Trend</h4>
                    <span style={{ fontSize: '11px', color: '#12B76A', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '3px' }}>
                      <ArrowUpRight size={13} /> +2.4% <span style={{ color: secTextColor, fontWeight: 400 }}>from last month</span>
                    </span>
                  </div>
                  ...
                  <div style={{ width: '100%', height: '200px', marginTop: '10px', paddingBottom: '5px' }}>
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={accuracyTrendData} margin={{ top: 15, right: 15, left: -5, bottom: 25 }}>
                        <defs>
                        ...
                        <CartesianGrid strokeDasharray="3 3" stroke={isDark ? 'rgba(255,255,255,0.06)' : '#EEF0F4'} vertical={false} />
                        <XAxis dataKey="date" stroke={mutedTextColor} fontSize={10} tickLine={false} height={30} dy={5} />
                        <YAxis domain={[90, 100]} stroke={mutedTextColor} fontSize={10} tickLine={false} tickFormatter={(v) => `${v}%`} width={38} />
