...
import { Scissors, User, Award, ShieldAlert, Heart, Star, Sparkles, MapPin, Truck, ChevronRight, Sun, Moon, RefreshCw, Check, Users, ShieldCheck, Headphones, ChevronLeft, Facebook, Instagram, Linkedin, Twitter, Play, Apple, Menu, X } from 'lucide-react';
...
export default function App() {
  ...
  const [authModalConfig, setAuthModalConfig] = useState({ role: 'tailor', tab: 'login' });
  ...
  return (
    <div className="app-container">
        ...
        <>
          <header className="top-nav">
            ...
            <div className="role-switcher desktop-nav-menu">
              ...
              <button 
                className="role-btn"
                onClick={() => navigateToSection('tailor-earnings')}
              >
                Earnings
              </button>
              <button 
                className="role-btn"
                onClick={() => navigateToSection('tailor-benefits')}
              >
                Benefits
              </button>
              <button 
                className="role-btn"
                onClick={() => navigateToSection('tailor-specialties')}
              >
                Specialties
              </button>
              <button 
                className="role-btn"
                onClick={() => navigateToSection('tailor-pricing')}
              >
                Pricing
              </button>
              <button 
                className="role-btn"
                onClick={() => navigateToSection('tailor-faqs')}
              >
                FAQs
              </button>
              <button 
            ...
            {/* User Profile / Auth Area (Visible on desktop & mobile) */}
                ...
                {currentUser ? (
                  ...
                  <>
                    <button 
                      ...
                      onClick={() => openAuthModal('tailor', 'login')}
                    >
                      Login
                    </button>
                    <button 
                      ...
                      style={{ minHeight: '32px', padding: '6px 12px', fontSize: '0.85rem' }}
                      onClick={() => openAuthModal('tailor', 'signup')}
                    >
                      Sign Up
                    </button>
                  </>
          ...
          {mobileMenuOpen && (
            <div className="mobile-dropdown-menu-v3" onClick={(e) => e.stopPropagation()}>
              <div className="mobile-menu-links-v3">
                ...
                <span 
                  className="mobile-menu-link-v3"
                  onClick={(e) => { e.stopPropagation(); navigateToSection('tailor-earnings'); setMobileMenuOpen(false); }}
                >
                  Earnings
                </span>
                <span 
                  className="mobile-menu-link-v3"
                  onClick={(e) => { e.stopPropagation(); navigateToSection('tailor-benefits'); setMobileMenuOpen(false); }}
                >
                  Benefits
                </span>
                <span 
                  className="mobile-menu-link-v3"
                  onClick={(e) => { e.stopPropagation(); navigateToSection('tailor-specialties'); setMobileMenuOpen(false); }}
                >
                  Specialties
                </span>
                <span 
                  className="mobile-menu-link-v3"
                  onClick={(e) => { e.stopPropagation(); navigateToSection('tailor-pricing'); setMobileMenuOpen(false); }}
                >
                  Pricing
                </span>
                <span 
                  className="mobile-menu-link-v3"
                  onClick={(e) => { e.stopPropagation(); navigateToSection('tailor-faqs'); setMobileMenuOpen(false); }}
                >
                  FAQs
                </span>
                <span 
      ...
      {/* Global Delivery-Style Premium Footer on landing/about/blogs roles */}
              ...
              <div className="footer-links-group-v4">
                ...
                <div className="footer-col-v4">
                  ...
                  <ul className="footer-links-v4">
                    <li><span className="footer-link-v4" onClick={() => setRole('become-tailor')}>About Us</span></li>
                    <li><span className="footer-link-v4" onClick={() => setRole('become-tailor')}>How It Works</span></li>
                    <li><span className="footer-link-v4" onClick={() => setRole('become-tailor')}>Earnings & Benefits</span></li>
                    <li><span className="footer-link-v4" onClick={() => setRole('become-tailor')}>Contact Us</span></li>
                  </ul>
                </div>

                {/* Column 3 – Partner */}
                <div className="footer-col-v4">
                  <h5 className="footer-heading-v4">Tailor Partner</h5>
                  <ul className="footer-links-v4">
                    <li><span className="footer-link-v4" onClick={() => setRole('signup')}>Become a Tailor</span></li>
                    <li><span className="footer-link-v4" onClick={() => setRole('login')}>Tailor Portal Login</span></li>
                    <li><span className="footer-link-v4" onClick={() => setRole('signup')}>Partner Support</span></li>
                    <li><span className="footer-link-v4" onClick={() => setRole('become-tailor')}>Partner FAQs</span></li>
                  </ul>
                </div>
              </div>
