      ...
      {(role === 'landing' || role === 'about' || role === 'blogs' || role === 'become-tailor' || role === 'become-delivery' || role === 'become-student' || role === 'customer') && (
        <footer id="contact-footer" className="premium-footer">
          ...
          <div className="footer-bottom">
            <span>&copy; 2026 StitchBee Technologies Private Limited. Tailor Partner Workspace.</span>
            <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
              Made with <Heart size={10} style={{ color: 'var(--primary)' }} /> for artisan custom styling.
            </span>
          </div>
          </div>
        </footer>
